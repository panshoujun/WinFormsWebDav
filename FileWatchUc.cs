...
{
    public partial class FileWatchUc : UserControl
    {
        public FileWatchUc()
        {
            InitializeComponent();
        ...
        private static void OnChanged(object source, FileSystemEventArgs e)
        {
            ...
            MessageBox.Show($"{e.FullPath}改变");
        }

        private static void OnDeleted(object source, FileSystemEventArgs e)
        {

            MessageBox.Show($"{e.FullPath}删除");
        }

        private static void OnRenamed(object source, RenamedEventArgs e)
        {

            MessageBox.Show($"{e.FullPath}重命名");
        }
        private static void OnOther(object source, FileSystemEventArgs e)
        {

            MessageBox.Show($"{e.FullPath}其他");
        ...
        private static int GetHandleCount(string filePath)
        {
            try
            {
        ...
        private static int GetHandleCount(SafeFileHandle handle)
        {
            try
            {
