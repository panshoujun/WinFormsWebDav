...
{
    public partial class FileLockAndUnLockUcNew : BaseUserControl
    {
        public event EventHandler ShowMessage;
        private readonly IHttpClientFactory _httpClientFactory;
        private readonly CloudPlatformOptions _cloudPlatformOptions;
        public FileLockAndUnLockUcNew(IHttpClientFactory httpClientFactory, IOptions<CloudPlatformOptions> cloudPlatformOptions)
        {
            InitializeComponent();
        ...
        private async void btnFileLock_Click(object sender, EventArgs e)
        {
            ...
            ShowMessage?.Invoke(this, new MessageEventArgs { Msg = $"{content}\n" });
        }
